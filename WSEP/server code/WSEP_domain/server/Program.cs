...
namespace server
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
           ...
           // Console.WriteLine("local end point: " + listener.LocalEndpoint);
            ...
            while (true)
            {
                ...
                CommObserverable co = new CommObserverable(s2);
                userID++;
        ...
        public static void threadFunction(object s1)
        {
            ...
            CommObserverable co = (CommObserverable)list.ElementAt(4);
          //  Console.WriteLine("remote endpoint: " + s.RemoteEndPoint);
            ...
            while (true)
            {
                ...
                if (!str.Equals(""))
                {
                    ...
                    Tuple<string, string, List<Tuple<string, string>>> ans = service.parseMessage2(str, co);
