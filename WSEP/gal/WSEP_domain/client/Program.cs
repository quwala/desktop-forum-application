...
namespace client
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                //bool res = true;
                string ans = c.addForum("Cars", "superAdmin");
               // Console.WriteLine(ans);
                
                ans = c.registerMemberToForum("Cars", "carsUser1", "carsPass1", "email1@gmail.com");
                //Console.WriteLine(ans);
                c.login("Cars", "carsUser1", "carsPass1");
                ans = c.registerMemberToForum("Cars", "carsUser2", "carsPass1", "email2@gmail.com");
               // Console.WriteLine(ans);
                ...
                ans = c.registerMemberToForum("Cars", "carsUser6", "carsPass6", "email6@gmail.com");
                Console.WriteLine(ans);
