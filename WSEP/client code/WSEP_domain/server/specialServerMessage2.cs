...
namespace server
{
    class specialServerMessage2
    {
        ...
        List<Tuple<string, string, DateTime, string>> data;


        public specialServerMessage2(messageType p1, List<Tuple<string, string, DateTime, string>> data)
        {
            _messageType = p1;
            this.data = data;
        }
