...
namespace WSEP_domain.forumManagement.threadsHandler
{
    public class Post
    {
        ...
        public static Post create(string title, string content, User user, Post repliedTo, int serialNumber, DateTime creationDate)
        {
            if (user == null)
            {
                return null;
            ...
            return new Post(title, content, user, repliedTo, serialNumber, creationDate);
        }
        ...
        private Post(string title, string content, User user, Post repliedTo, int serialNumber, DateTime creationDate)
        {
            _repliedTo = repliedTo;
            _title = title;
            _content = content;
