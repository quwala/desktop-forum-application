...
namespace WSEP_service.notificationManagementService
{
    public class NotificationManager : INotificationsManager
    {
        ...
        {
            systemsEmail = "gmrrstests@gmail.com";
            systemEmailPassword = "gmrrs123";
        }
        ...
        public bool NotifyPost(string postResponser_username, string postOwner_username, string postOwner_email)
        {
            ...
            try
            {
                ...
                SmtpClient client = new SmtpClient
                {
                    ...
                    Credentials = new System.Net.NetworkCredential(systemsEmail, systemEmailPassword),
                    Timeout = 10000,
                };
