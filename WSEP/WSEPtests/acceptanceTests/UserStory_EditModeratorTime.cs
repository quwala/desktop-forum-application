...
namespace WSEPtests.acceptanceTests
{
    ...
    public class UserStory_EditModeratorTime
    {
        ...
        public void Test_EditModeratorTime_CatastophicInput()
        {
            ...
            //Assert.isFalse(fs.EditModeratorTime("forumName","subForumName","UserName,-1));       //time is negative              
            //Assert.isFalse(fs.EditModeratorTime("forumName","subForumName","UserName,NULL));       //time is null           
