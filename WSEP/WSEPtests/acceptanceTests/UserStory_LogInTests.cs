...
namespace WSEPtests.acceptanceTests
{
    ...
    public class UserStory_LogInTests
    {
        ...
        public void Test_LogIn_GoodInput()
        {
            ...
            //Assert.isFalse(fs.ForumLogIn("invalidForumName","UserName","UserPassword"));          //try to login with good invalid forumname
        ...
        public void Test_LogIn_CatastophicInput()
        {
            ...
            // Assert.isFalse(fs.ForumLogIn("forumName","UserName",NULL));                                          
