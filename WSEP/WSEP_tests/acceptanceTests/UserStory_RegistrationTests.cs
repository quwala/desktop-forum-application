...
namespace WSEP_tests.acceptanceTests
{
    ...
    public class UserStory_RegistrationTests
    {
        ...
        public void Test_Registration_BadInput()
        {
            ...
            Assert.IsFalse(adapter.registerToForum("forumName", "UserName2", "UserPassword2", "galMor1007@gmail.com")); //TID 30         //test on invalid Mail addresses
            ...
            Assert.IsFalse(adapter.registerToForum("forumName", "UserName", "simplepassword", "galMor1007@gmail.com"));  //TID 33       //to simple password
