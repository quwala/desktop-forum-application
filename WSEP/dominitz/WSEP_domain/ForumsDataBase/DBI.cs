...
namespace ForumsDataBase
{
    ...
    {
        Boolean addForumUser(string userName,string password,string email,DateTime registration , string forumName,DateTime lastPassChange );   //boolean on sucesses
        ...
        List<Tuple<string, string, string, DateTime, DateTime>> ReturnForumUsers(string forumName);                      //username,password,email,registration,lastPassChange
    }
}
