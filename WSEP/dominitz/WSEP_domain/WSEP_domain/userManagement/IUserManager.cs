...
namespace WSEP_domain.userManagement
{
    ...
    {
        void readForumMembers(string forumName, List<User> members);
        void readForumAdmins(string forumName, List<User> admins);
        void readSubForumModerators(string forumName, string subForumName, List<Tuple<User, string, DateTime, int>> moderators);
